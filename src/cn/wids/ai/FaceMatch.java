    ...
    */
    public static String match() {
        ...
        try {
            ...
            byte[] bytes1 = FileUtil.readFileByBytes("d:/test/1001.jpeg");
            byte[] bytes2 = FileUtil.readFileByBytes("d:/test/1002.jpg");
    ...
    public static void main(String[] args) {
        String reslut=FaceMatch.match();
        JSONObject obj = JSONObject.parseObject(reslut);
        String  s = obj.getString("result");
        JSONObject obj02 = JSONObject.parseObject(s);
        String scoreStr = obj02.getString("score");
